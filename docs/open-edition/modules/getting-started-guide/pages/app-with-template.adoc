...
To learn more about the panels and functionalities of the _App Designer_, see xref:cockpit-overview:app-designer-user-interface-at-a-glance.adoc[_App Designer_ interface at a glance].
