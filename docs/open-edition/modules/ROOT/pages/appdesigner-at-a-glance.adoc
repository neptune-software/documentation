...
//Helle@Helle: resize box outline
...
+
* image:../../cockpit-overview/images/appdesigner-views-stack.png[width=45]
Combine the *Reusable component* panel and *Application component* panel.
* image:../../cockpit-overview/images/appdesigner-views-switch.png[width=45]
Switch *Application component* panel and *UI object* panel.
* image:../../cockpit-overview/images/appdesigner-views-hideUI.png[width=45]
