...
To learn more about the panels and functionalities of the _App Designer_, go to xref:cockpit-overview:appdesigner-at-a-glance.adoc[_App Designer_ interface at a glance].
...
//Helle@Helle: redo, *OpenUI5* added
