...
=== Create a deployment package
. Click the arrow next to the service you want to deploy artefacts from.
+
NOTE: The number next to the service name indicates the number of available artefacts.
+
. Select a service. In the example, we selected *Launchpad* in the *Administration* tab.
+
*Result* A list of all artefacts of the selected service is shown.
+
