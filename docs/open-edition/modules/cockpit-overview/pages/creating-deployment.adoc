...
+
. To select a service you want to deploy artefacts from, click the arrow next to the service group. In the example, we selected *Launchpad* from the *Administration* service group.
