...
//Fabian: As far as I understand it, "Jobs" run independently from apps. They are scripts (or batch files) that are started at a certain time and run for a certain time.
