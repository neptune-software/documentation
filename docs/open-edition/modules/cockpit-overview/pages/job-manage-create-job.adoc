...
//todo fabian: I deleted "...that you can integrate in your applications." from the introductory sentence since Hendrik said that it's not the intended use. If you agree, you can delete the conversation here. :)
