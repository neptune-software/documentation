...
//Helle@Fabian: Documentation = Development? Maybe mention in task rather than here.

image::script-editor-overview.png[,800]
//Helle@Fabian: I'd cut Design and simplify icons of other tiles with circles. Cover/delete "last used tiles" (upper left corner).
