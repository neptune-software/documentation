= Configure an external API with the API Designer

In this topic, you learn how to configure an API to communicate with an API outside Neptune DXP - Open Edition.
...
* You have configured created an API to communicate with an external API.
