...
//Fabian: According to the style guide, services are the only elements we write in italics (apart from file names, which are rare). That means, writing "System Settings" in italics and with upper case should be enough to identify it as a service in my opinion.
//Fabian: There should be an article before a service.
